...
const DEFAULT_PARTIES = ["s", "m", "l", "kd", "v", "sd", "c", "mp", "nyd"];
...
module.exports = async function getMotionsByParty(fromDateStrOverride = new Date(2000, 0, 1), toDateStrOverride = new Date(2018, 0, 1), parties = DEFAULT_PARTIES) {
  ...
  return Promise.all([posResponse, negResponse]).then(function (responseQueue) {
    var i = 0;
    var partyData = [];
    parties.forEach(function (party) {
